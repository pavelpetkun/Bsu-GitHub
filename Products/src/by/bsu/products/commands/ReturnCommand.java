...
public final class ReturnCommand extends AbstractCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, LogicException {
        ...
        try {
            ...
            if (subcategory == null) {
                transformer = StylesheetCache.newTransformer(PathName.PATH + PathName.XSL_CATEGORY);
            } else {
                transformer = StylesheetCache.newTransformer(PathName.PATH + PathName.XSL_SUBCATEGORY);
